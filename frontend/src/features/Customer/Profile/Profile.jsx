...
const Profile = () => {
  ...
  const menuItems = [
    ...
    { text: 'Phiên đấu giá', icon: <Gavel />, value: 4 },
    {
      ...
      value: 5,
      subItems: [
        { text: 'Yêu cầu', value: 'requests' },
        { text: 'Tài sản', value: 'assets' },
        { text: 'Phiên đấu giá', value: 'auctions' },
      ],
    },
        ...
        <Grid container spacing={3} justifyContent="center">
          ...
          <Grid item xs={12} sm={8} md={9} lg={9}>
            <StyledPaper elevation={3}>
              ...
              {tab === 3 && <WonItems />}
              {tab === 4 && <AuctionInfo />}
              {tab === 5 && subTab === 'requests' && <AuctionRequest />}
              {tab === 5 && subTab === 'assets' && <MyAssets />}
              {tab === 5 && subTab === 'auctions' && <MyAssets />}
            </StyledPaper>
          </Grid>
        </Grid>
